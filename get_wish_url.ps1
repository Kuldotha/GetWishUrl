...
# Method 1
$cachePath = "$gameDataPath\\webCaches\\2.16.0.0\\Cache\\Cache_Data\\data_2"
...
$cachePath = "$gameDataPath\\webCaches\\2.16.0.0\\Service Worker\\CacheStorage\\f944a42103e2b9f8d6ee266c44da97452cde8a7c"
if (Test-Path $cachePath) {
...
$cachePath = "$gameDataPath\\webCaches\\2.16.0.0\\Cache\\Cache_Data"
